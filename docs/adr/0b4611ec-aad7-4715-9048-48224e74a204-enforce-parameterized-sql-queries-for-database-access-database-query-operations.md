...
1. MUST: Database query operations (SELECT, INSERT, UPDATE, DELETE) that accept external input MUST pass parameters through the values array of the query configuration object

## Policy Block

- MUST Database query operations (SELECT, INSERT, UPDATE, DELETE) that accept external input MUST pass parameters through the values array of the query configuration object
