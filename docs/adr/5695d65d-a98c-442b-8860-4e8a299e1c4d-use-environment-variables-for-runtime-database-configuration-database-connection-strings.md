...
1. MUST: Database connection strings MUST be sourced from the DATABASE_URL environment variable using process.env.DATABASE_URL

## Policy Block

- MUST Database connection strings MUST be sourced from the DATABASE_URL environment variable using process.env.DATABASE_URL
