...
1. MUST: The pool instance MUST be reused across all route handlers rather than creating new connections per request

## Policy Block

- MUST The pool instance MUST be reused across all route handlers rather than creating new connections per request
