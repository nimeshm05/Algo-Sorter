...
1. SHOULD: Services SHOULD execute SELECT, INSERT, and UPDATE operations through the shared pool instance rather than creating new connections

## Policy Block

- SHOULD Services SHOULD execute SELECT, INSERT, and UPDATE operations through the shared pool instance rather than creating new connections
