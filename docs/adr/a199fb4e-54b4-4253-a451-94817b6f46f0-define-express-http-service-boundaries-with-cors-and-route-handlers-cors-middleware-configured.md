...
1. MUST: CORS middleware MUST be configured with explicit allowedHeaders to restrict cross-origin requests to approved origins only

## Policy Block

- MUST CORS middleware MUST be configured with explicit allowedHeaders to restrict cross-origin requests to approved origins only
