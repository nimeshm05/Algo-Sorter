...
1. MUST: PostgreSQL connection pools MUST be initialized with SSL configuration using rejectUnauthorized setting

## Policy Block

- MUST PostgreSQL connection pools MUST be initialized with SSL configuration using rejectUnauthorized setting
