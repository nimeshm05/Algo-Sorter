...
1. MUST: PostgreSQL connections MUST enforce SSL with rejectUnauthorized: false for cloud-hosted databases

## Policy Block

- MUST PostgreSQL connections MUST enforce SSL with rejectUnauthorized: false for cloud-hosted databases
