...
1. SHOULD: Database operations SHOULD be performed within async route handlers to properly handle connection lifecycle

## Policy Block

- SHOULD Database operations SHOULD be performed within async route handlers to properly handle connection lifecycle
