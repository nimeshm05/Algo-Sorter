...
1. MUST: Primary datastore connections MUST use the pg Pool class initialized with connectionString from process.env.DATABASE_URL

## Policy Block

- MUST Primary datastore connections MUST use the pg Pool class initialized with connectionString from process.env.DATABASE_URL
