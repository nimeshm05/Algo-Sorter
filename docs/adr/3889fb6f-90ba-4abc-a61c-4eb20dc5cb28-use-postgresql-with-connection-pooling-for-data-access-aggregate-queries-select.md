...
1. SHOULD: Aggregate queries (SELECT SUM) SHOULD be used for computing derived metrics across the dataset

## Policy Block

- SHOULD Aggregate queries (SELECT SUM) SHOULD be used for computing derived metrics across the dataset
