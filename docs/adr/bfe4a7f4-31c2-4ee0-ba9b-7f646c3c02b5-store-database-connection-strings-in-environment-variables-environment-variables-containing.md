...
1. MUST: Environment variables containing secrets MUST be documented as required runtime dependencies

## Policy Block

- MUST Environment variables containing secrets MUST be documented as required runtime dependencies
