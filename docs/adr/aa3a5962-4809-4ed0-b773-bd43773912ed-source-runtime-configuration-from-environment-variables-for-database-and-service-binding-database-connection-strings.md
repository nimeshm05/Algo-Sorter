...
1. MUST: Database connection strings MUST be sourced from environment variables (process.env.DATABASE_URL) rather than hardcoded in application source code

## Policy Block

- MUST Database connection strings MUST be sourced from environment variables (process.env.DATABASE_URL) rather than hardcoded in application source code
