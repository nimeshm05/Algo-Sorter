...
1. MUST: Database access MUST use a connection pool initialized with connectionString from process.env.DATABASE_URL

## Policy Block

- MUST Database access MUST use a connection pool initialized with connectionString from process.env.DATABASE_URL
