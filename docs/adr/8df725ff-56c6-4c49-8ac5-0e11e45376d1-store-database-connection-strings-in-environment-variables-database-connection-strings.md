...
1. MUST: Database connection strings MUST be sourced from process.env.DATABASE_URL environment variable

## Policy Block

- MUST Database connection strings MUST be sourced from process.env.DATABASE_URL environment variable
