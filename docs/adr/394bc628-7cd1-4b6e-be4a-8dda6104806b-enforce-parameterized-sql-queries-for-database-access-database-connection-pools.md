...
1. MUST: All database connection pools MUST be configured with appropriate SSL settings when connecting to remote databases

## Policy Block

- MUST All database connection pools MUST be configured with appropriate SSL settings when connecting to remote databases
