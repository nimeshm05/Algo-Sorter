...
1. MUST_NOT: Credentials, connection strings, or other secrets MUST NOT be committed to version control in plaintext

## Policy Block

- MUST_NOT Credentials, connection strings, or other secrets MUST NOT be committed to version control in plaintext
