...
1. SHOULD: Database access patterns SHOULD be reviewed during code review to verify parameterization is correctly applied

## Policy Block

- SHOULD Database access patterns SHOULD be reviewed during code review to verify parameterization is correctly applied
