...
1. MUST: Database connections MUST be managed through a connection pool initialized with connectionString from process.env.DATABASE_URL

## Policy Block

- MUST Database connections MUST be managed through a connection pool initialized with connectionString from process.env.DATABASE_URL
