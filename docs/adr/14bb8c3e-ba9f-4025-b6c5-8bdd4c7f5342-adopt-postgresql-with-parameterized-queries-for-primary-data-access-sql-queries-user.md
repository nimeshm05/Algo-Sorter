...
1. MUST: All SQL queries with user-supplied data MUST use parameterized queries with $1, $2, etc. placeholders and separate values arrays

## Policy Block

- MUST All SQL queries with user-supplied data MUST use parameterized queries with $1, $2, etc. placeholders and separate values arrays
