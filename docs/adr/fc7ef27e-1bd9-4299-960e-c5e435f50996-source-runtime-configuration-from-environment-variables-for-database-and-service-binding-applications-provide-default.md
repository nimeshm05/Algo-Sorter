...
1. MAY: Applications MAY provide default values for non-sensitive configuration when environment variables are absent

## Policy Block

- MAY Applications MAY provide default values for non-sensitive configuration when environment variables are absent
