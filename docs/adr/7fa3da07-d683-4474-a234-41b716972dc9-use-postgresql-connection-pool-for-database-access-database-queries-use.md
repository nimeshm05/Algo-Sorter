...
1. MUST: All database queries MUST use parameterized queries with the $1, $2 placeholder syntax to prevent SQL injection

## Policy Block

- MUST All database queries MUST use parameterized queries with the $1, $2 placeholder syntax to prevent SQL injection
