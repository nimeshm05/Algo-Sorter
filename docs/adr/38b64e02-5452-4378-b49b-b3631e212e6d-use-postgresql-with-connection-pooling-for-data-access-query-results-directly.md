...
1. MAY: Query results MAY be directly accessed via the rows array property for result set processing

## Policy Block

- MAY Query results MAY be directly accessed via the rows array property for result set processing
