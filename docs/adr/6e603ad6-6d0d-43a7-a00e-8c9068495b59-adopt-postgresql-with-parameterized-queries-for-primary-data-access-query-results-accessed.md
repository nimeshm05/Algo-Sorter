...
1. SHOULD: Query results SHOULD be accessed via the rows property of the query result object

## Policy Block

- SHOULD Query results SHOULD be accessed via the rows property of the query result object
