...
1. MUST: Database queries MUST use parameterized statements with $1, $2 placeholders and values arrays to prevent SQL injection

## Policy Block

- MUST Database queries MUST use parameterized statements with $1, $2 placeholders and values arrays to prevent SQL injection
