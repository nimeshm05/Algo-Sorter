...
1. SHOULD: SSL configuration for database connections SHOULD be included in the connection pool initialization with rejectUnauthorized set to false for cloud-hosted databases

## Policy Block

- SHOULD SSL configuration for database connections SHOULD be included in the connection pool initialization with rejectUnauthorized set to false for cloud-hosted databases
