...
1. MUST: All database connections MUST enforce SSL with rejectUnauthorized set to false for cloud database providers

## Policy Block

- MUST All database connections MUST enforce SSL with rejectUnauthorized set to false for cloud database providers
