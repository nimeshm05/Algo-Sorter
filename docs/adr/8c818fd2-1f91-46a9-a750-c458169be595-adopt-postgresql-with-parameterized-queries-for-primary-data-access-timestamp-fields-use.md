...
1. SHOULD: Timestamp fields SHOULD use new Date() for current timestamp values in INSERT and UPDATE operations

## Policy Block

- SHOULD Timestamp fields SHOULD use new Date() for current timestamp values in INSERT and UPDATE operations
