...
1. MAY: Applications MAY disable SSL certificate validation (rejectUnauthorized: false) only when connecting to managed database services that use self-signed certificates

## Policy Block

- MAY Applications MAY disable SSL certificate validation (rejectUnauthorized: false) only when connecting to managed database services that use self-signed certificates
