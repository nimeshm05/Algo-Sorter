...
1. MUST_NOT: Database credentials, hostnames, or connection parameters MUST_NOT be hardcoded in application source code

## Policy Block

- MUST_NOT Database credentials, hostnames, or connection parameters MUST_NOT be hardcoded in application source code
