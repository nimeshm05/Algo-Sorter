...
1. SHOULD: Database query patterns (SELECT, INSERT, UPDATE) SHOULD use the query method with text and values properties for clarity and type safety

## Policy Block

- SHOULD Database query patterns (SELECT, INSERT, UPDATE) SHOULD use the query method with text and values properties for clarity and type safety
