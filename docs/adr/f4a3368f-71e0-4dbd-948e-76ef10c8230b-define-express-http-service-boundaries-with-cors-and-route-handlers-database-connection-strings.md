...
1. MUST: Database connection strings and sensitive configuration MUST be sourced from process.env variables, never hardcoded

## Policy Block

- MUST Database connection strings and sensitive configuration MUST be sourced from process.env variables, never hardcoded
