...
1. MUST: CORS middleware MUST be configured with an explicit allowlist of permitted origins rather than using wildcard (*) or permissive configurations

## Policy Block

- MUST CORS middleware MUST be configured with an explicit allowlist of permitted origins rather than using wildcard (*) or permissive configurations
