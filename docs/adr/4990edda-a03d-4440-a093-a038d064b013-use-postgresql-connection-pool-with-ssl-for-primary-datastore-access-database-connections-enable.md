...
1. MUST: Database connections MUST enable SSL with rejectUnauthorized set to false for managed database services

## Policy Block

- MUST Database connections MUST enable SSL with rejectUnauthorized set to false for managed database services
