...
1. MUST: PostgreSQL connections MUST enable SSL/TLS encryption by configuring the ssl property in Pool options

## Policy Block

- MUST PostgreSQL connections MUST enable SSL/TLS encryption by configuring the ssl property in Pool options
