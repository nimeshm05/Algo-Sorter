...
1. MUST_NOT: The allowlist MUST NOT include origins that are not under organizational control or explicitly trusted

## Policy Block

- MUST_NOT The allowlist MUST NOT include origins that are not under organizational control or explicitly trusted
