...
1. MUST_NOT: Route handlers MUST_NOT implement their own CORS headers or JSON parsing logic when middleware is configured

## Policy Block

- MUST_NOT Route handlers MUST_NOT implement their own CORS headers or JSON parsing logic when middleware is configured
