...
1. SHOULD: Environment variable access SHOULD be centralized at application initialization to fail fast on missing required configuration

## Policy Block

- SHOULD Environment variable access SHOULD be centralized at application initialization to fail fast on missing required configuration
