...
1. MUST: Database connection strings MUST be sourced from process.env.DATABASE_URL at runtime

## Policy Block

- MUST Database connection strings MUST be sourced from process.env.DATABASE_URL at runtime
