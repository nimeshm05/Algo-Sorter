...
1. SHOULD: Pool queries SHOULD use the object form with text and values properties for parameterized queries

## Policy Block

- SHOULD Pool queries SHOULD use the object form with text and values properties for parameterized queries
