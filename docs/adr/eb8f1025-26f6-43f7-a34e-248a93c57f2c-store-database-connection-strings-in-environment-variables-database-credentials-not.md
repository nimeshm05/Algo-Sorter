...
1. MUST_NOT: Database credentials MUST NOT be hardcoded in source code or committed to version control

## Policy Block

- MUST_NOT Database credentials MUST NOT be hardcoded in source code or committed to version control
