...
1. MUST: Server port configuration MUST be sourced from process.env.PORT environment variable

## Policy Block

- MUST Server port configuration MUST be sourced from process.env.PORT environment variable
