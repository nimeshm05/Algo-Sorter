...
1. MUST: All database connections MUST use the pg Pool with connectionString from process.env.DATABASE_URL and SSL with rejectUnauthorized: false

## Policy Block

- MUST All database connections MUST use the pg Pool with connectionString from process.env.DATABASE_URL and SSL with rejectUnauthorized: false
