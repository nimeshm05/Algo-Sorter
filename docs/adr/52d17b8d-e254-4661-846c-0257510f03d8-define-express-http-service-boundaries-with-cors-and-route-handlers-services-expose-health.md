...
1. MAY: Services MAY expose health check or status endpoints that aggregate database query results

## Policy Block

- MAY Services MAY expose health check or status endpoints that aggregate database query results
