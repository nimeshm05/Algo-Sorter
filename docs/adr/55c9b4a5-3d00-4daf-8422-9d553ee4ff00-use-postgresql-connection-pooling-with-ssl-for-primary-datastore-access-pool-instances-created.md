...
1. SHOULD: Pool instances SHOULD be created once at application startup and reused across all request handlers

## Policy Block

- SHOULD Pool instances SHOULD be created once at application startup and reused across all request handlers
