...
1. MUST: Production origins MUST use HTTPS protocol with fully qualified domain names in the allowlist

## Policy Block

- MUST Production origins MUST use HTTPS protocol with fully qualified domain names in the allowlist
