...
1. MUST: Visitor tracking MUST implement three query patterns: SELECT SUM for aggregation, SELECT with WHERE for lookup, INSERT for new records, and UPDATE with WHERE for modifications

## Policy Block

- MUST Visitor tracking MUST implement three query patterns: SELECT SUM for aggregation, SELECT with WHERE for lookup, INSERT for new records, and UPDATE with WHERE for modifications
