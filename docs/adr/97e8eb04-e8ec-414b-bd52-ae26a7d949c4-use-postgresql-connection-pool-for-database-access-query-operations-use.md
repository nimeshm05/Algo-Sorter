...
1. SHOULD: Query operations SHOULD use the pool.query() method with text and values properties for parameterized queries

## Policy Block

- SHOULD Query operations SHOULD use the pool.query() method with text and values properties for parameterized queries
