...
1. SHOULD: Database connection pools SHOULD be initialized once at application startup and reused across requests

## Policy Block

- SHOULD Database connection pools SHOULD be initialized once at application startup and reused across requests
