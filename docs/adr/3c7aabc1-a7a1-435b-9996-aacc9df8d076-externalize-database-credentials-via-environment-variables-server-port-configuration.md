...
1. MUST: Server port configuration MUST be sourced from process.env.PORT to support platform-assigned port binding

## Policy Block

- MUST Server port configuration MUST be sourced from process.env.PORT to support platform-assigned port binding
