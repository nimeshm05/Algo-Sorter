...
1. MUST: Server port configuration MUST be sourced from the PORT environment variable using process.env.PORT

## Policy Block

- MUST Server port configuration MUST be sourced from the PORT environment variable using process.env.PORT
