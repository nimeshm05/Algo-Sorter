...
1. MUST: All SQL queries that incorporate dynamic values MUST use parameterized queries with placeholder syntax ($1, $2, etc.) and separate values arrays

## Policy Block

- MUST All SQL queries that incorporate dynamic values MUST use parameterized queries with placeholder syntax ($1, $2, etc.) and separate values arrays
